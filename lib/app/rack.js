...
exports.init = function (app) {
    ...
    if (devOrTest) {
        ...
        // Generator
        var routesPath = '/' + path.relative(paths.JS, paths.CLIENT_ROUTES),
            viewsPath = '/' + path.relative(paths.JS, paths.CLIENT_VIEWS);
    ...
    rack.use('/upl', statik(paths.PUBLIC_UPLOAD, { maxAge: staticMaxAge }), { connect: true });
